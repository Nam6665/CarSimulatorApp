        ...
        public async Task<IActionResult> Index(SimulationViewModel viewModel)
        {
            ...
            if (viewModel.IsRunning)
            {
                ...
                else
                {
                    ...
                    viewModel.SelectedAction = 0;
                }

                if (viewModel.CurrentStatus.IsGameOver)
                {
                ...
                if (!string.IsNullOrEmpty(viewModel.CurrentStatus.CurrentActionMessage))
                {
                    viewModel.CurrentActionMessage = viewModel.CurrentStatus.CurrentActionMessage;
                }
                ...
                viewModel.HungerStatusMessage = viewModel.CurrentStatus.GetHungerStatus().ToString();
            }
